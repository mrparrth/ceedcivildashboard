  ...
  return (
    <div className="flex justify-center items-center  w-2/6 bg-gray-100 loginPage">
      <div className="p-6 rounded-lg w-full border bg-white shadow-md loginForm">
        ...
        <h2 className="text-2xl font-bold text-center mb-4 text-gray-700 text-[25px]">
          Login Page
        </h2>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label
              htmlFor="email"
              className="block text-[15px] text-gray-700 font-semibold mb-2"
            >
              <strong>Email:</strong>
            </label>
            <input
              ...
              className={`w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-300 h-16 text-[15px] ${
