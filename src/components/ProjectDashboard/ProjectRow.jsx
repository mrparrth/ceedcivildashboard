    ...
    (newSelectedOptions) => {
      ...
      updateTimeoutRef.current = setTimeout(() => {
        ...
        updateProject({
          ...
          mepTaskedTo,
          civilTaskedTo,
          draftingNeeded: draftingTaskedTo.length > 0,
          engineeringNeeded: engineeringTaskedTo.length > 0,
          mepNeeded: mepTaskedTo.length > 0,
          civilNeeded: civilTaskedTo.length > 0,
        });
      ...
      <tr key={project.id} className={getRowStyle()}>
        ...
        <td>
          <MultiSelectDropdown
            ...
            setSelectedOptions={handleAssignedToChange}
