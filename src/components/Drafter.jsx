...
const Drafter = () => {
  ...
  const drafterTaskToOptions = window.MetaData.taskTo;
  const draftingStatusOptions = window.MetaData.status;

  const fields = [
    {
      label: "Drafter Needed",
      name: "drafterNeeded",
      type: "select",
      options: ["Yes", "No"],
    },
    {
      ...
      type: "select",
      options: drafterTaskToOptions,
    },
    {
      label: "Drafting Status",
      name: "draftingStatus",
      type: "select",
      options: draftingStatusOptions,
    },
